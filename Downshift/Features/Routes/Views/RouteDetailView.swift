...
struct RouteDetailView: View {
    ...
    private func setupMapData() {
        ...
        if allCoordinates.count > 1, let lastCoord = allCoordinates.last, let firstCoord = allCoordinates.first, firstCoord.latitude != lastCoord.latitude || firstCoord.longitude != lastCoord.longitude {
